...
//                mCoveredFadeColor = ta.getColor(R.styleable.SlidingUpPanelLayout_umanoFadeColor, DEFAULT_FADE_COLOR);
                mCoveredFadeColor = ta.getColor(R.styleable.SlidingUpPanelLayout_umanoFadeColor, Color.TRANSPARENT);
    ...
    void dispatchOnPanelSlide(View panel) {
        if (mPanelSlideListener != null) {
            mPanelSlideListener.onPanelSlide(panel, mSlideOffset, position);
        }
    }
    ...
    public boolean smoothSlideTo(float slideOffset, int velocity) {
        ...
        if (mDragHelper.smoothSlideViewTo(mSlideableView, mSlideableView.getLeft(), panelTop, velocity)) {
...
//    public void forceSetViewAt(float slideOffset, int Velocity) {
//        if (!isEnabled() || mSlideableView == null) {
//            // Nothing to do.
//        	return ;
//        }
//        
//        int panelTop = computePanelTopPosition(slideOffset);
//        mSlideableView.setTranslationY(panelTop);
//    }
    @Override
