...
public class LostSetupActivity  extends Activity implements OnClickListener, OnSeekBarChangeListener{
	...
	private LostSetupActivity activity;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_lost_only_setup);
	...
	private void initView2() {
		//勿扰区域是否打开了
		if (ApplicationSharedPreferences.getIsOpenNoAlarmArea(LostSetupActivity.this)) {
...
//			startAntiLostService();
	...
	private void set_antilost_no_alarm_area() {
		Intent intent = new Intent(LostSetupActivity.this, NoAlarmAreaActivity.class);
...
//		}
	...
	public static void gotoAntiLostActivity(Context context) {
		...
		intent.setClass(context, LostSetupActivity.class);
