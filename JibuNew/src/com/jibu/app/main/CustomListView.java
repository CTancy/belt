...
import android.widget.TextView;
 ...
 //        setCacheColorHint(android.R.color.black);
         ...
         mHeadView = (LinearLayout) mInflater.inflate(R.layout.linearlayout_sync, null);
 ...
 //        mArrowImageView.setMinimumHeight(50);
     ...
     public void onRefreshComplete() {
         mState = DONE;
         mLastUpdatedTextView.setText("宸插姞杞藉畬鎴愶細" + new Date().toLocaleString());
     ...
     private void changeHeaderViewByState() {
         ...
         case DONE:
             ...
             mProgressBar.setVisibility(GONE);
          //   mArrowImageView.clearAnimation();
          //   mArrowImageView.setImageResource(R.drawable.title_back);
     ...
     public void setAdapter(ListAdapter adapter) {
         mLastUpdatedTextView.setText("开始加载:" + new Date().toLocaleString());
